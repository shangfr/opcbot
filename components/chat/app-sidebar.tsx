...
export function AppSidebar({ user, isAdmin }: { user: User | undefined; isAdmin: boolean; }) {
  ...
  return (
    <>
      <Sidebar className="border-r border-sidebar-border shadow-[var(--shadow-sidebar)]" collapsible="icon" >
        {/* ===== Logo / Brand 区域 ===== */}
          ...
          <SidebarGroup className="px-2 pt-3">
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                {user && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="智库" >
                ...
                {user && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="智客" >
                ...
                {user && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="智汇" >
                ...
                {user && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="智品" >
                ...
                {user && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="知识库" >
                ...
                {user && isAdmin && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="数据看板" >
                ...
                {user && isAdmin && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-9 gap-2.5 rounded-lg text-[15px] text-sidebar-foreground/65 transition-all duration-150 hover:bg-sidebar-accent hover:text-sidebar-foreground" tooltip="用户管理" >
